	...
	void setupAnimations() {
		if(playerType == A) {
			runLeftImages	= new BufferedImage[] {
				Sprite.getSprite(0, 0, 32, 32, "res/titanclones/runLeft.png"),
				Sprite.getSprite(1, 0, 32, 32, "res/titanclones/runLeft.png"),
				Sprite.getSprite(2, 0, 32, 32, "res/titanclones/runLeft.png")
			};
			
			runRightImages = new BufferedImage[] {
				Sprite.getSprite(0, 0, 32, 32, "res/titanclones/runRight.png"),
				Sprite.getSprite(1, 0, 32, 32, "res/titanclones/runRight.png"),
				Sprite.getSprite(2, 0, 32, 32, "res/titanclones/runRight.png")
			};
		...
		if(playerType == B) {
			runLeftImages	= new BufferedImage[] {
				Sprite.getSprite(0, 0, 32, 32, "res/titanclones/runLeftB.png"),
				Sprite.getSprite(1, 0, 32, 32, "res/titanclones/runLeftB.png"),
				Sprite.getSprite(2, 0, 32, 32, "res/titanclones/runLeftB.png")
			};
			
			runRightImages = new BufferedImage[] {
				Sprite.getSprite(0, 0, 32, 32, "res/titanclones/runRightB.png"),
				Sprite.getSprite(1, 0, 32, 32, "res/titanclones/runRightB.png"),
				Sprite.getSprite(2, 0, 32, 32, "res/titanclones/runRightB.png")
			};
